        ...
        <div class="card">
                        ...
                        <li class="tbl-header-btn">
                            <div class="mat-mdc-tooltip-trigger m-l-10"
                                ...
                                <button class="mdc-fab mdc-fab--mini mat-mdc-mini-fab mat-primary mat-mdc-button-base"
                                    data-bs-toggle="modal" data-bs-target="#ModRegMedicine">
                                    <mat-icon
                                        class="mat-icon notranslate col-white material-icons mat-ligature-font mat-icon-no-color">
                                        add</mat-icon>
                                </button>
                            </div>
                        </li>
            ...
            <div class="body overflow-auto">
                <div class="responsive_table">
                    @csrf
                    <table id="editable"
                        class="mat-mdc-table mdc-data-table__table cdk-table mat-sort mat-cell advance-table table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <form class="alertDelete" method="POST"
                                    action="{{ route('medicine.delete',$medicine) }}" accept-charset="UTF-8"
...
@section('scripts')
<script src="
https://cdn.jsdelivr.net/npm/jquery-tabledit@1.0.0/jquery.tabledit.min.js
"></script>
<script type="text/javascript">
    ...
    columns: {
        identifier: [0, 'id'],
        editable: [[1, 'product'], [2, 'price'], [3, 'description']]
    },
    restoreButton: false,
    ...
    onDraw: function () {
        // se reemplzaa los iconos, ya que es del bostrap 3 está deprecado
        $('#editable .glyphicon-pencil').removeClass('glyphicon-pencil').addClass('material-icons').text('edit');
        $('#editable .glyphicon-trash').removeClass('glyphicon-trash').addClass('material-icons').text('delete');
        $('.input-sm').on('focus', function() {
            $(this).addClass('focus');
        });
...
{{-- <div class="modal fade" id="ModEditMedicine" aria-labelledby="ModEditMedicine" data-bs-backdrop="static"
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <form id="edit_form_medicine" role="form" class="text-start" method="POST" action=""
                ...
                <div class="modal-body">
                    ...
                    <div class="input-group input-group-outline mt-2 mb-4">
                        <div class="col-6">
                            <div class="input-group input-group-outline me-2 focused is-focused">
                                ...
                                <input id="product-edit" type="text" class="form-control product" name="product"
                                    required>
                            </div>
                    ...
                    <div class="input-group input-group-outline mt-2 mb-4">
                        <div class="input-group input-group-outline  mb-3">
                            <textarea id="descrip-edit" name="description" class="form-control description" rows="5"
...
<div class="modal fade" id="ModRegMedicine" tabindex="-1" aria-labelledby="ModRegMedicine" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <form id="MedicineRegister" role="form" class="text-start" method="POST"
                action="{{route('medicine.register')}}" enctype="multipart/form-data">
                {!! csrf_field() !!}
                <div class="modal-body">
                    ...
                    <div class="input-group input-group-outline mt-2 mb-4">
                        <div class="input-group input-group-outline  mb-3">
                            <textarea id="descrip" name="description" class="form-control" rows="5"
                                placeholder="Description" spellcheck="false"></textarea>
                        </div>
                    </div>
                </div>
